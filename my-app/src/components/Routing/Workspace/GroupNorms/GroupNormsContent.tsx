...
export const HoldingsContent: FC = () => {
  return (
    ...
    <p>Workspace purpose and a bit of context. This much is needed description is here to remind people where they are, if they are new or have poor memory.</p>
     </HoldingsContentWrapper>
     <CogWrapper>
